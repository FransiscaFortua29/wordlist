...
password = 'sparta'
cxn_str = f'mongodb+srv://fransiscafortuasimamora29:{password}@cluster0.4ftdsad.mongodb.net/?retryWrites=true&w=majority'
...
def detail(keyword):
    api_key = 'e27d9f68-7c65-486b-a339-4beec32479f7'
...
def not_find():
    ...
    if pesan:
        pesan = pesan.split(',')
    return render_template("error.html", msg=msg, pesan=pesan)
